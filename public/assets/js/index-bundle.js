...
var _completed = __webpack_require__(14);
	...
	"/": {
		view: function view(_ref) {
			...
			return (0, _mithril2.default)(
				_shell.Shell,
				null,
				(0, _mithril2.default)(_chooseProject.ChooseProject, attrs)
			);
		}
	},
	"/question_page/:project_id": {
		view: function view(_ref2) {
			...
			return (0, _mithril2.default)(
				_shell.Shell,
				null,
				(0, _mithril2.default)(_questionPage.QuestionPage, attrs)
			);
		}
	},
	"/question_page/:project_id/completed": {
		view: function view(_ref3) {
			...
			return (0, _mithril2.default)(
				_shell.Shell,
				null,
				(0, _mithril2.default)(_completed.Completed, attrs)
			);
		}
	}
});
...
exports.Shell = exports.SideBar = exports.Head = undefined;
...
var SideBar = exports.SideBar = {
	view: function view() {
		return (0, _mithril2.default)(
			"main",
			{ id: "menu", "class": "bg-dark-gray vh-100 white dn" },
			(0, _mithril2.default)(
				"header",
				null,
				(0, _mithril2.default)(
...
var Shell = exports.Shell = {
	view: function view(_ref2) {
		...
		return (0, _mithril2.default)(
			"section",
			null,
			(0, _mithril2.default)(SideBar, null),
			(0, _mithril2.default)(
				"section",
				{
					id: "panel",
...
exports.ChooseProject = exports.ListItem = undefined;
		...
		return (0, _mithril2.default)(
			...
			(0, _mithril2.default)(
				...
				(0, _mithril2.default)(
					"div",
					{
						"class": (0, _classnames2.default)("w-70 dib  pa4 ", {
							"bg-gray": !active,
							"bg-dark-red": active
						})
					},
				...
				(0, _mithril2.default)(
					"span",
					{
						"class": (0, _classnames2.default)("dark-red  absolute frx pt4 ", {
							dn: !active,
							dib: active
						}),
...
var ChooseProject = exports.ChooseProject = {
	oncreate: function oncreate() {
		_data.Data.GetProjects();
	},
	view: function view() {
		return (0, _mithril2.default)(
			"section",
...
exports.QuestionPage = exports.Foot = undefined;
...
var Foot = exports.Foot = {
	view: function view(_ref) {
		var attrs = _ref.attrs;

		return (0, _mithril2.default)(
			"div",
			{ "class": "fixed bottom-0 w-100 red bg-dark-gray shadow-4 bt b--white-50" },
			(0, _mithril2.default)(
				"a",
				{
				...
				(0, _mithril2.default)("img", { src: "/assets/img/check.svg", "class": "w2 dib" }),
				(0, _mithril2.default)(
					"span",
					{ "class": "db" },
					"Ajouter"
...
var QuestionPage = exports.QuestionPage = {
	oncreate: function oncreate(_ref2) {
		var attrs = _ref2.attrs;

		// console.log(vnode)
		console.log(attrs);
		_data.Data.GetTasks(attrs.project_id);
	},
	processFile: function processFile(e, task_id) {
		console.log(e);
		...
		if (/\.(jpe?g|png|gif)$/i.test(file.name)) {
			...
			reader.addEventListener("load", function () {
				...
				_data.Data.TaskSetUploadedImage(task_id, this.result);
			}, false);
	...
	view: function view(_ref3) {
		...
		var filteredData = _data.Data.Tasks.filter(function (v) {
			return v.question == "1";
		});
		_data.Data.TotalTaskItems = filteredData.length;
		...
		return (0, _mithril2.default)(
				...
				filteredData.map(function (data, i) {
					return (0, _mithril2.default)(
						...
						(0, _mithril2.default)(
							...
							(0, _mithril2.default)(
								"div",
								{ "class": "pa4 bg-dark-gray bt bb b--white tc" },
								(0, _mithril2.default)(
									"span",
									null,
									data.fr_description
							...
							(0, _mithril2.default)(
								"div",
								{ "class": "dark-gray tc bg-light-gray cf" },
								(0, _mithril2.default)("input", {
									...
									id: "yes" + data.task_id,
									onchange: _mithril2.default.withAttr("checked", function (v) {
										return v ? _data.Data.TaskSetBoolAnswer(data.task_id, true) : _data.Data.TaskSetBoolAnswer(data.task_id, false);
									})
								}),
								(0, _mithril2.default)(
									"label",
								...
								(0, _mithril2.default)("input", {
									...
									id: "no" + data.task_id,
									onchange: _mithril2.default.withAttr("checked", function (v) {
										return v ? _data.Data.TaskSetBoolAnswer(data.task_id, false) : _data.Data.TaskSetBoolAnswer(data.task_id, true);
									})
								}),
								(0, _mithril2.default)(
									"label",
							...
							(0, _mithril2.default)(
								...
								(0, _mithril2.default)(
									...
									(0, _mithril2.default)("img", { src: "/assets/img/upload.svg", "class": "w2 dib v-mid" }),
									(0, _mithril2.default)(
										"span",
										{ "class": "dib navy v-mid" },
										"Upload Image"
									)
								),
								(0, _mithril2.default)("input", {
									...
									onchange: function onchange(e) {
										return QuestionPage.processFile(e, data.task_id);
									}
								})
							),
							(0, _mithril2.default)(
								...
								(0, _mithril2.default)("img", {
									src: _data.Data.TaskAnswers[data.task_id] ? _data.Data.TaskAnswers[data.task_id].image : "",
									"class": "w5 dib"
								})
							)
						)
			...
			(0, _mithril2.default)(Foot, { project_id: attrs.project_id })
		);
	}
};
	...
	view: function view() {
		return (0, _mithril2.default)(
			...
			(0, _mithril2.default)(
				...
				(0, _mithril2.default)(
					"div",
					{ "class": "pa4 bg-dark-gray bt bb b--white tc f2 dark-red" },
					(0, _mithril2.default)(
						"span",
						null,
						"STATUT: 85%"
				...
				(0, _mithril2.default)(
					...
					(0, _mithril2.default)(
						"span",
						null,
						"Envoie des donn\xE9es collect\xE9es"
					)
				),
				(0, _mithril2.default)(
					"a",
